...
/**
 * Basic function to show how to insert a value into a Word Document.
 */
...
export async function createSlide() {
    ...
    try {
        await Word.run(async function (context) {
            ...
            //const shapes: Word.ShapeCollection = newSlide.shapes;
            //var textbox: Word.Shape = shapes.addTextBox("Hello World!",
            //    {
            //        left: 255,
            //        top: 50,
            //        height: 50,
            ...
            //// https://learn.microsoft.com/en-us/office/dev/add-ins/tutorials/word-tutorial-yo#insert-an-image
